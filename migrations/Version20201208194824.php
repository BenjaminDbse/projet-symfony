 ...
 */
final class Version20201208194824 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program RENAME INDEX fk_program_1_idx TO IDX_92ED778412469DE2');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program RENAME INDEX idx_92ed778412469de2 TO fk_program_1_idx');
    }
}
